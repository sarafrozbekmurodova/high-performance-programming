# Script for checking A4.tar.gz file for Assignment 4 subimssion
...
echo Checking that running galsim executable works on 1 thread
./galsim 10 ../../../input_data/ellipse_N_00010.gal 200 1e-5 0 1 || exit 1
...
echo Checking that running galsim executable works on 4 thread
./galsim 10 ../../../input_data/ellipse_N_00010.gal 200 1e-5 0 4 || exit 1
